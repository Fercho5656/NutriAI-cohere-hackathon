<template>
  <svg class="stroke-gray-200 dark:stroke-slate-800 transition-colors" width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
